...
$replacements = [
    'contentstack\\\\utils\\\\' => function () use(&$values) { return str_replace('\\', '\\\\', $values['psr4_namespace']) . '\\\\'; },
    'Contentstack'                 => function () use(&$values) { return $values['author_name']; },
    'Contentstack'             => function () use(&$values) { return $values['author_github_username']; },
    'https://www.contentstack.com'              => function () use(&$values) { return $values['author_website'] ?: ('https://github.com/' . $values['author_github_username']); },
    'support@contentstack.com'                => function () use(&$values) { return $values['author_email'] ?: ($values['author_github_username'] . '@example.com'); },
    'contentstack'                      => function () use(&$values) { return $values['package_vendor']; },
    'utils'                => function () use(&$values) { return $values['package_name']; },
